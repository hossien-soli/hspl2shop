...
import dev.hspl.hspl2shop.user.model.domain.User;
import dev.hspl.hspl2shop.user.model.domain.UserRepository;
import dev.hspl.hspl2shop.user.model.impl.jpa.UserJpaEntity;
import dev.hspl.hspl2shop.user.model.impl.jpa.UserJpaRepository;
